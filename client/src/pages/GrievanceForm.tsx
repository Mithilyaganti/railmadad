      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-gray-700 p-3 rounded-lg shadow-md border-l-4 border-yellow-400">
            <label htmlFor="pnr" className="block text-sm font-medium text-gray-300 mb-1">PNR Number</label>
            <input
              type="text"
              id="pnr"
              name="pnr"
        ...
        <div className="bg-gray-700 p-3 rounded-lg shadow-md border-l-4 border-pink-400">
          <label htmlFor="image" className="block text-sm font-medium text-gray-300 mb-1">Upload Image</label>
          <input
            type="file"
            id="image"
            name="image"
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            className="px-6 py-2 bg-[#ff9999] text-gray-900 font-semibold rounded-md hover:bg-[#ffb3b3] focus:outline-none focus:ring-2 focus:ring-[#ff9999] focus:ring-offset-2 focus:ring-offset-gray-800 transition duration-150 ease-in-out transform hover:-translate-y-1 hover:scale-105 text-sm"
          >
            Submit Grievance
          </button>
        </div>
